...
def spektrumDiagram(fileList,dataLabel):
  ...
  for i in range (0,len(fileList)):
    dataList.append(readCSV(fileList[i]))
  magnitudeSpektrum(dataList, dataLabel,1,1)
...
spektrumFiles = ["D4 spektrum Peak hold 35 kHz R=.7.csv","D4 spektrum Peak hold 35 kHz R=.7.csv","D4 spektrum Peak hold 35 kHz R=304.csv","D4 spektrum Peak hold 35 kHz R=718.csv","D4 spektrum Peak hold 35 kHz R=5k.csv","D4 spektrum Peak hold 35 kHz R=10.2k.csv"]

dataLabel = ["$R_2$ = 0,7$\Omega$","$R_2$ = 304$\Omega$","$R_2$ = 718$\Omega$","$R_2$ = 5k$\Omega$","$R_2$ = 10,2k$\Omega$"]
